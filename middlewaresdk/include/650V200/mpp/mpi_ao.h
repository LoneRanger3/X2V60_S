...
XM_S32 XM_MPI_AO_SendFrame(AUDIO_DEV AoDevId, AO_CHN AoChn, const AUDIO_FRAME_S *pstData, XM_BOOL bBlock);
XM_S32 XM_MPI_AO_ClrBuf(AUDIO_DEV AoDevId);
XM_S32 XM_MPI_AO_QueryChnStat(AUDIO_DEV AoDevId ,AO_CHN AoChn, AO_CHN_STATE_S *pstStatus);
