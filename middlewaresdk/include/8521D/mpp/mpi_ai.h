...
XM_S32 XM_MPI_AI_Enable(AUDIO_DEV AudioDevId, AI_CHN AiChn);   
XM_S32 XM_MPI_AI_Disable(AUDIO_DEV AudioDevId, AI_CHN AiChn);  

XM_S32 XM_MPI_AI_GetFrame(AUDIO_DEV AudioDevId, AI_CHN AiChn, 
    AUDIO_FRAME_S *pstFrm, AEC_FRAME_S *pstAecFrm, XM_BOOL bBlock);

XM_S32 XM_MPI_AI_Bind(MPP_CHN_S *pstSrcChn, MPP_CHN_S *pstDestChn);	

XM_S32 XM_MPI_AI_RegisterFunc(AUDIO_DEV AiDevId, AI_CHN AiChn, fAudioPreCallBack func);
