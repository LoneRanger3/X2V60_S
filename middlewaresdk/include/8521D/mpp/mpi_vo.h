...
XM_S32 XM_MPI_VO_GetEmptyFrame(VO_LAYER VoLayer, VO_CHN VoChn, VIDEO_FRAME_INFO_S *pstVFrame, XM_S32 s32MilliSec);
...
XM_S32 XM_MPI_VO_GetImageLayerAttr(VO_LAYER VoLayer, VO_IMAGE_LAYER_ATTR_S *pstLayerAttr);
XM_S32 XM_MPI_VO_EnableImageLayer(VO_LAYER VoLayer);
XM_S32 XM_MPI_VO_DisableImageLayer(VO_LAYER VoLayer);

XM_S32 XM_MPI_VO_SetCursorLayerAttr(VO_LAYER VoLayer, const VO_CURSOR_LAYER_ATTR_S *pstLayerAttr);
XM_S32 XM_MPI_VO_GetCursorLayerAttr(VO_LAYER VoLayer, VO_CURSOR_LAYER_ATTR_S *pstLayerAttr);
XM_S32 XM_MPI_VO_CursorLayerSetBitMap(VO_LAYER VoLayer, VO_CURSOR_LAYER_BITMAP_S *pstBitMap);
XM_S32 XM_MPI_VO_EnableCursorLayer(VO_LAYER VoLayer);
XM_S32 XM_MPI_VO_DisableCursorLayer(VO_LAYER VoLayer);

XM_S32 XM_MPI_VO_SetVideoLayerAttr(VO_LAYER VoLayer, const VO_VIDEO_LAYER_ATTR_S *pstLayerAttr);
XM_S32 XM_MPI_VO_GetVideoLayerAttr(VO_LAYER VoLayer, VO_VIDEO_LAYER_ATTR_S *pstLayerAttr);

XM_S32 XM_MPI_VO_SetWbcSource(VO_WBC VoWbc, const VO_WBC_SOURCE_S *pstWbcSource);
XM_S32 XM_MPI_VO_GetWbcSource(VO_WBC VoWbc, VO_WBC_SOURCE_S *pstWbcSource);
XM_S32 XM_MPI_VO_SetWbcAttr(VO_WBC VoWbc, const VO_WBC_ATTR_S *pstWbcAttr);
XM_S32 XM_MPI_VO_GetWbcAttr(VO_WBC VoWbc, VO_WBC_ATTR_S *pstWbcAttr);
XM_S32 XM_MPI_VO_EnableWbc(VO_WBC VoWbc);
XM_S32 XM_MPI_VO_DisableWbc(VO_WBC VoWbc);
XM_S32 XM_MPI_VO_SetWbcDepth(VO_WBC VoWbc, XM_U32 u32Depth);
XM_S32 XM_MPI_VO_GetWbcDepth(VO_WBC VoWbc, XM_U32 *pu32Depth);
XM_S32 XM_MPI_VO_GetWbcFrame(VO_WBC VoWbc, VIDEO_FRAME_INFO_S *pstVFrame, XM_S32 s32MilliSec);
XM_S32 XM_MPI_VO_ReleaseWbcFrame(VO_WBC VoWbc, VIDEO_FRAME_INFO_S *pstVFrame);
XM_S32 XM_MPI_VO_Bind(MPP_CHN_S *pstSrcChn, MPP_CHN_S *pstDestChn);

XM_S32 XM_MPI_VO_ResetVideoLayer(VO_LAYER VoLayer);
XM_S32 XM_MPI_VO_DsiSendCmd(VO_DEV VoDev, const VO_DSI_CMD_LIST_S *pstCmdList);
