...
{
    XM_S32 s32MaxLev;         /*s32MaxLev£º[-23dBm0, -4dBm0]¡£default: -4dBm0*/
    XM_S32 s32MinLev;         /*s32MinLev£º [-23dBm0, -4dBm0]¡£default: -16dBm0*/
    XM_U32 u32MaxGain;        /*u32MaxGain£º[3dB,12dB]¡£default: 12dB*/
} AI_ALC_CONFIG_S;
...
typedef struct xmAI_VQE_CONFIG_S
{
    ...
    XM_S32              bAnrOpen;
    XM_S32              bAgcOpen;
    XM_S32              s32SampleRate;  /* Sample Rate£º8KHz/11.025K/12K/16KHz¡£default: 8KHz*/
    XM_S32              s32FrameSample; /* VQE frame length£º
