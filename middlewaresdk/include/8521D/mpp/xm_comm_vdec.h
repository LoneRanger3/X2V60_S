#ifndef __XM_COMM_VDEC_H__
#define __XM_COMM_VDEC_H__
...
//#define XM_TRACE_VDEC(level, fmt...) XM_TRACE(level, XM_ID_VDEC, ##fmt)
...
typedef struct xmVDEC_DEV_ATTR_S
{
...
typedef struct xmVDEC_DEV_PARAM_S
{
...
typedef struct
{
	XM_U32 u32CropEnabled;  /* whether cropping is enabled */
	XM_U32 u32Cropx;        /* cropping start x */
	XM_U32 u32Cropy;        /* cropping start y */
	XM_U32 u32CropWidth;    /* cropping width */
	XM_U32 u32CropHeight;   /* cropping height */
	XM_U32 u32OutWidth;    /*  vdec chn output width */
	XM_U32 u32OutHeight;   /*  vdec chn output height */
}VDEC_CHN_ATTR_S;
